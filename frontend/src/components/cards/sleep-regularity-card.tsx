...
export function SleepRegularityCard({ snapshots }: SleepRegularityCardProps) {
  ...
  return (
    <div className="rounded-[1.5rem] border border-slate-900/10 bg-white/85 p-5 shadow-[0_18px_42px_rgba(17,35,30,0.08)] backdrop-blur">
      ...
      <h3 className="mt-3 font-['Fraunces'] text-2xl tracking-[-0.04em] text-slate-900">Como dormi ao longo da rotina?</h3>
      <p className="mt-2 text-sm leading-6 text-slate-500">
        Regularidade de horários e diferença entre dias úteis e fim de semana.
      </p>

      <div className="mt-4 grid gap-3 md:grid-cols-2">
        <article className="rounded-2xl border border-slate-900/10 bg-slate-50/80 p-4">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-slate-500">Sleep Regularity Index</p>
          <div className="mt-2 flex items-end justify-between gap-3">
            <div>
              <p className="font-['Fraunces'] text-4xl tracking-[-0.06em] text-slate-900">
        ...
        <article className="rounded-2xl border border-slate-900/10 bg-slate-50/80 p-4">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-slate-500">Social Jet Lag</p>
          <div className="mt-2 flex items-end justify-between gap-3">
            <div>
              <p className="font-['Fraunces'] text-4xl tracking-[-0.06em] text-slate-900">
