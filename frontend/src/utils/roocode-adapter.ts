...
function metricsRecordToHealthRow(record: MetricsRecord): HealthAutoExportRow | null {
  ...
  return {
    ...
    heartRateMin: record['Frequência Cardíaca [Mínimo] (bpm)'] ?? null,
    heartRateMax: record['Frequência Cardíaca [Máx] (bpm)'] ?? null,
    heartRateMean: record['Frequência Cardíaca [Média] (bpm)'] ?? null,
